...
<div class="container py-4">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="h3 fw-bold">Edit Produk</h1>
                    ...
                    <form action="{{ route('admin.produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('toko_id') is-invalid @enderror"
                                ...
                                <option value="{{ $toko->id }}" {{ old('toko_id', $produk->toko_id) == $toko->id ? 'selected' : '' }}>
                                    {{ $toko->nama_toko }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file"
                                   ...
                                   accept="image/*">
                            <div class="form-text">
                                Pilih satu atau lebih gambar tambahan (maksimal 2MB per gambar, format: JPEG, PNG, JPG, GIF)
                            </div>
                            @error('gambar')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
