        ...
        <div class="col-lg-8">
            <div class="card shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="card-title mb-0 fw-bold">Form Tambah Toko</h5>
                </div>
                <div class="card-body">
                    @if($errors->any())
                    ...
                    <form action="{{ route('toko.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_toko" name="nama_toko" value="{{ old('nama_toko') }}" placeholder="Masukkan nama toko" required>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="kontak_toko" name="kontak_toko" value="{{ old('kontak_toko') }}" placeholder="Masukkan nomor telepon atau email" required>
                        </div>

                        <div class="mb-3">
                            <label for="alamat" class="form-label fw-semibold">Alamat Toko <span class="text-danger">*</span></label>
                            <textarea class="form-control" id="alamat" name="alamat" rows="3" placeholder="Masukkan alamat lengkap toko" required>{{ old('alamat') }}</textarea>
                        </div>

                        <div class="mb-3">
                            <label for="deskripsi" class="form-label fw-semibold">Deskripsi Toko</label>
                            <textarea class="form-control" id="deskripsi" name="deskripsi" rows="4" placeholder="Masukkan deskripsi toko (opsional)">{{ old('deskripsi') }}</textarea>
                        </div>
