                ...
                <div class="card-header bg-white border-0 border-bottom py-3 rounded-top-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 fw-semibold text-dark">
                            <i class="bi bi-people me-2 text-muted"></i> Daftar Pengguna
                        </h5>
                        <a href="{{ route('users.create') }}" class="btn btn-success btn-sm fw-semibold shadow-sm px-3">
                            ...
                            <tbody class="bg-white">
                                ...
                                <tr class="table-row-hover">
                                    ...
                                    <td class="text-center">
                                        ...
                                        @else
                                            <span class="badge rounded-pill bg-secondary text-light px-3 py-2">
                                        ...
                                        <div class="d-flex justify-content-center gap-2">
                                            <form action="{{ route('users.destroy', $user) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus pengguna ini?')">
                                                ...
                                                <div class="btn-group" role="group">
                                                    <button type="button" class="btn btn-sm btn-outline-secondary action-btn" title="Lihat Detail" onclick="window.location='{{ route('users.show', $user) }}'">
                                                        <i class="bi bi-eye"></i>
                                                    </button>
                                ...
                                <tr>
                                    <td colspan="6" class="text-center py-5 text-muted">
                                        ...
                                        <h6 class="fw-semibold mb-0">Tidak ada pengguna ditemukan</h6>
                                        <small>Silakan tambahkan pengguna baru.</small>
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
