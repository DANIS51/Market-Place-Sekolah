...
<div class="container py-4">
    ...
    <div class="mb-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 section-header">
            ...
            <a href="{{ route('pengguna.kategori') }}"
                       ...
                       class="text-decoration-none">
                        <div class="card h-100 border-0 shadow-sm rounded-4 store-card overflow-hidden">
                            <div class="card-body d-flex flex-column align-items-center justify-content-center text-center">
                                ...
                                <div class="rounded-circle d-flex align-items-center justify-content-center bg-primary bg-opacity-10 mb-3"
    ...
    <div class="mb-5">
        ...
        <div class="row g-3">
            ...
            @forelse($tokos as $toko)
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <a href="{{ route('pengguna.toko.show', Crypt::encrypt($toko->id)) }}"
                       class="text-decoration-none">
    ...
    <div class="mb-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 section-header">
            ...
            <a href="{{ route('show.produk.index') }}"
               class="btn btn-outline-primary btn-sm rounded-pill">
                Lihat Semua <i class="bi bi-arrow-right"></i>
            </a>
        </div>
                ...
                <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden product-card">
                    ...
                    <div class="position-relative product-image-container">
                        ...
                        @if($produk->gambar_produk && $produk->gambar_produk->count() > 0)
                            ...
                            @if($produk->gambar_produk->count() > 1)
                                ...
                                <div id="carousel-home-{{ $produk->id }}"
                                    ...
                                    <button class="carousel-control-prev"
                                            type="button"
                                            data-bs-target="#carousel-home-{{ $produk->id }}"
                                            data-bs-slide="prev">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div>
                                <span class="h5 text-success fw-bold d-block">
